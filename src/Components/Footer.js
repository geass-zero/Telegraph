...
const Footer = () => {
  return (
    <div color="blue" className="footer pt-4 mt-4">
      <Container className=" text-md-left">
        <Row>
          <Col>
            <div>
              <Box
                className="ready-to-start Montserrat"
                sx={{
                  display: "flex",
              ...
              >
                ...
                >
                  <p style={{ alignSelf: "center" }}>Ready to get started?</p>
                  <Button
                    // style={{ alignSelf: "start" }}
                    variant="primary"
                    className="justify-content-end blue-btn Montserrat"
                  >
                    Get started
                  </Button>
                </Box>
        ...
        >
          <Grid
            ...
            md={12}
            lg={3}
            sx={{ marginBottom: { xs: "8%", lg: 0 } }}
          >
            <Typography
              sx={{ textAlign: { xs: "center", md: "center", lg: "start" } }}
              className="Montserrat dev-title"
            >
              Developers
            </Typography>
            <Typography
              ...
              className="dev-Typography Montserrat"
            >
              Documentation operate a <br />
              node
            </Typography>
          </Grid>
      ...
      <Container>
        <div className="copy-rights" style={{display:'flex', flexDirection:'column', justifyContent:'center', width:"100%", alignItems:'center'}}>
          <p>© 2021 Telegraph • All Right Reserved</p>
          <div className="social-media">
            <Row>
              <Col style={{display:'flex',  marginBottom:'15%'}}>
                <a href="">
                  <svg
                    width="10"
                    height="20"
